 ...
 */
export declare const BABYJUBJUB_ORDER = 2736030358979909402780800718157159386076813972158567259200215660948447373041n;
/**
 * BN254 SNARK scalar field prime.
 */
export declare const SNARK_FIELD = 21888242871839275222246405745257275088548364400416034343698204186575808495617n;
/**
 * Domain separator used when signing for key derivation.
 */
export declare const KEY_DERIVATION_MESSAGE = "Shade Protocol Key Derivation v1";
/**
 * Domain separator for viewing key derivation (appended to the signature hash).
 */
export declare const VIEWING_KEY_DOMAIN = "Shade Protocol Viewing Key v1";
/**
