 ...
 */
export async function computeCommitment(npk, tokenId, value) {
 ...
 */
export async function computeNullifier(nullifyingKey, leafIndex) {
    const poseidon = await getPoseidon();
 ...
 */
export function computeTokenId(tokenAddress) {
 ...
 */
export async function createNote(masterPublicKey, tokenAddress, value) {
 ...
 */
export async function createNoteWithRandom(masterPublicKey, tokenAddress, value, random) {
    const npk = await generateNotePublicKey(masterPublicKey, random);
    const token = computeTokenId(tokenAddress);
    const commitment = await computeCommitment(npk, token, value);
    return { npk, random, token, value, commitment };
 ...
 */
export async function toOwnedNote(note, leafIndex, nullifyingKey) {
 ...
 */
export async function createDummyNote(masterPublicKey, tokenAddress) {
 ...
 */
export async function createDummyNoteWithTokenId(masterPublicKey, tokenId) {
    const random = randomFieldElement();
    const npk = await generateNotePublicKey(masterPublicKey, random);
